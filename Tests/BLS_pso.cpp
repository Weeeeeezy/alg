...
#include "TradingStrats/BLS/Common/pso/ParticleEngine.hpp"
...
using ParticleEngine_t = ParticleEngine<QTO, QRO>;
...
int main(int argc, char *argv[]) {
  ...
  // create selector
  auto pso_params = pt.get_child("ParticleSwarm");
  auto strat_params = pt.get_child("Strategy");
  ParticleEngine_t pso(pso_params, strat_params, parallel, in_sample_recs, 0);
