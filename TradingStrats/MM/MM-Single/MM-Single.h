// vim:ts=2:et
//===========================================================================//
//                  "TradingStrats/MM-Single/MM-Single.h":                   //
...
namespace MAQUETTE {
  ...
  class MM_Single final : public Strategy
  {
  private:
    ...
    struct IPair {
      ...
      // "a_outer"  is a "MM_Single" obj which this "IPair" belongs to:
      IPair(MM_Single*                   a_outer,
      ...
      template <bool Buffered>
      void
      CancelOrderSafe(AOS const*     a_aos,    // Non-NULL
                      utxx::time_val a_ts_exch,
                      utxx::time_val a_ts_recv,
                      utxx::time_val a_ts_strat);
      ...
      PriceT GetPxAtVol(bool a_is_bid, QR a_qty) const;
    ...
    public:
      ...
      DelayedGracefulStop(MM_Single*     a_outer,
                          utxx::time_val a_ts_strat,
                          Args&&... args);
    };
    ...
    //-----------------------------------------------------------------------//
    // XXX: Reactor and Connectors are contained INSIDE the "MM_Single"
  ...
  public:
    ...
    //=======================================================================//
    MM_Single(EPollReactor*                a_reactor,
              spdlog::logger*              a_logger,
              boost::property_tree::ptree& a_params  // XXX: Mutable!
    );

    ~MM_Single() noexcept override;
