                       ...
                       strncmp(a_http_code, "4", 1)  == 0))
    {
      ...
      if constexpr (IsFut)
      {
        ...
        LOG_INFO(2, "EConnector_H2WS_Binance_OMC::OnHeaders: ConnH2: "
                    "StreamID={}, ReqID={}",    a_stream_id, reqID)
      }
    }
  }
# if defined(__GNUC__) && !defined(__clang__)
...
# endif
  ...
  )
  {
    ...
    LOG_INFO(4,
      "EConnector_H2WS_Binance_OMC::ProcessH2Msg: StreamID={}, ReqID={}: "
    ...
    catch (std::exception const& exn)
    {
      ...
      LOG_ERROR(2,
        ...
        "StreamID={}, ReqID={}, ClOrdID={}, OrigClOrdID={}, OrderID={}",
        exn.what(), a_msg_body,  a_stream_id, reqID, clOrdID, origClOrdID,
        orderID)
      return false;
    }
    // All Done:
