  ...
  )
  {
    ...
    if (QueryOff > 0)
    {
      ...
      DEBUG_ONLY(int ok =)
        gnutls_hmac_fast
          (GNUTLS_MAC_SHA256,
           OMCH2WS::m_account.m_APISecret.data(),
           OMCH2WS::m_account.m_APISecret.size(),
           query,   queryLen, m_signSHA256);
      assert(ok == 0);
    ...
    try
    {
      ...
      for (SecDefD const* sd: EConnector::m_usedSecDefs)
      {
        ...
        *msg = '\0';       // 0-terminate it for logging
        ...
        LOG_INFO(2, "EConnector_H2WS_Binance_OMC::CancelAllOrders: Symbol={}, "
                    "StreamID={}", sd->m_Symbol.data(), streamID)
  ...
  void EConnector_H2WS_Binance_OMC<AC>::RequestAPIKey()
  {
    ...
    try
    {
      ...
      *msg = '\0';     // 0-terminate it for logging
      ...
      LOG_INFO(2, "EConnector_H2WS_Binance_OMC::RequestAPIKey: StreamID={}",
                   streamID)
      OMCH2WS::RotateH2Conns();
    }
    catch (std::exception const& exn)
    ...
    if constexpr (IsFut)
      try
      {
        ...
        *msg = '\0';         // 0-terminate it for logging
        ...
        LOG_INFO(2, "EConnector_H2WS_Binance_OMC::RequestPositions: "
                    "StreamID={}", streamID)
    ...
    if constexpr (!IsFut)
      try
      {
        ...
        *msg = '\0';     // 0-terminate it for logging
        ...
        LOG_INFO(2, "EConnector_H2WS_Binance_OMC::RequestBalance: StreamID={}",
                    streamID)
        OMCH2WS::RotateH2Conns();
      }
      catch (std::exception const& exn)
  ...
  void EConnector_H2WS_Binance_OMC<AC>::RequestListenKey()
  {
   if (utxx::unlikely(OMCH2WS::m_currH2Conn == nullptr))
    ...
    try
    {
      ...
      LOG_INFO(2, "EConnector_H2WS_Binance_OMC::RequestListenKey: StreamID={}",
                  streamID)
      OMCH2WS::RotateH2Conns();
