...
namespace OptInfo
{
  ...
  constexpr size_t sizeof_opt_rejected_orders = 416;
  constexpr size_t opt_rejected_orders_index = 0;
  ...
  constexpr size_t sizeof_opt_intercl_info = 48;
  constexpr size_t opt_intercl_info_index = 1;
  ...
  constexpr size_t sizeof_opt_exp_orders = 68;
  constexpr size_t opt_exp_orders_index = 2;
  ...
  constexpr size_t sizeof_opt_vcb = 204;
  constexpr size_t opt_vcb_index = 3;
  ...
  constexpr size_t sizeof_opt_sess_contents = 376;
  constexpr size_t opt_sess_contents_index = 4;
  ...
  constexpr size_t sizeof_opt_sess_settl = 92;
  constexpr size_t opt_sess_settl_index = 5;
